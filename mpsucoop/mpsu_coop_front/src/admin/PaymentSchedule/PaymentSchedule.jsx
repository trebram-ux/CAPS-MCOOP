...
// Calculate remaining balance per selected year
const calculateRemainingBalance = () => {
  return schedules
    .filter(schedule => !selectedYear || new Date(schedule.due_date).getFullYear().toString() === selectedYear)  // Filter by selected year
