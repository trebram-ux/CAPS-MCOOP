...
const LoanManager = () => {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/get-members/")  // Replace with your API URL
                  ...
                  <div className="form-group d-flex justify-content-between">
                    ...
                    <label>Co Maker 1</label>
                      <select
                        ...
                        onChange={(e) => setLoanData({ ...loanData, co_make: e.target.value })}
                        className="form-control"
                      >
                  ...
                  <div className="form-group d-flex justify-content-between">
                    <div className="flex-fill mr-2">
                      ...
                      <select
                        ...
                        onChange={(e) => setLoanData({ ...loanData, co_make_2: e.target.value })}
                        className="form-control"
                      >
                        <option value="">Select Co Maker</option>
                        {members.map(member => (
                  ...
                  <div className="form-group d-flex justify-content-between">
                    <div className="flex-fill mr-2">
                      ...
                      <select
                        ...
                        onChange={(e) => setLoanData({ ...loanData, co_make_3: e.target.value })}
                        className="form-control"
                      >
                        <option value="">Select Co Maker</option>
                        {members.map(member => (
                  ...
                  <div className="form-group d-flex justify-content-between">
                    <div className="flex-fill mr-2">
                      ...
                      <select
                        ...
                        onChange={(e) => setLoanData({ ...loanData, co_make_4: e.target.value })}
                        className="form-control"
                      >
                        <option value="">Select Co Maker</option>
                        {members.map(member => (
                  ...
                  <div className="form-group d-flex justify-content-between">
                    <div className="flex-fill mr-2">
                      ...
                      <select
                        ...
                        onChange={(e) => setLoanData({ ...loanData, co_make_5: e.target.value })}
                        className="form-control"
                      >
                        <option value="">Select Co Maker</option>
                        {members.map(member => (
